function init_sidebar() {
    ...
    $SIDEBAR_MENU.find("a").on("click", function (b) {
        ...
        c.is(".active") ? (c.removeClass("active active-sm"), $("ul", c).slideUp(function () {
            a()
        }
        )) : (c.parent().is(".child_menu") ? $BODY.is(".nav-sm") && ($SIDEBAR_MENU.find("li").removeClass("active active-sm"), $SIDEBAR_MENU.find("li ul").slideUp()) : ($SIDEBAR_MENU.find("li").removeClass("active active-sm"), $SIDEBAR_MENU.find("li ul").slideUp()), c.addClass("active"), $("ul", c).slideDown(function () {
            a()
        }
        ));
    }
