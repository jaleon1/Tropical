...
#####################################################################################
# Database name
$config['db']['name'] = "api_base";
# Database password
$config['db']['pwd'] = 'Story2018';
# Database user name
$config['db']['user'] = "storydb";
# Database host
// $config['db']['host'] = "104.131.5.198";
...
#
##############################################################################
$config['crypto']['key'] = "ZILdJBo142w6elIVjK0OR7dcyuCf+pIUyJ76LnKRgoo=";
...
$config['core']['siteName'] = 'tropical';

# The host name for your site
$config['core']['host'] = "tropical.com";
