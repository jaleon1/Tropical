        ...
        try{
            ...
            if($sArray->resp->Status==400){
                ...
                if ($resp400 === false) 
                    ...
                    historico::create(self::$transaccion->id, self::$transaccion->idBodega, self::$transaccion->idDocumento, 2, 'El documento ya fue recibido anteriormente, STATUS('.$sArray->resp->Status.')');
