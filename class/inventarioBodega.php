    ...
    public static function entrada($idInsumo, $inOrden, $inCantidad, $inCostoUnitario){
        try {
            $sql="SELECT saldoCantidad, saldoCosto 
                FROM insumosXBodega WHERE id=:idInsumo;";
            ...
            else throw new Exception('Error al consultar el codigo del insumo para actualizar inventario ('.$idInsumo.')' , ERROR_ENTRADA_INVENTARIO_BODEGA);
        }
        catch(Exception $e) {
